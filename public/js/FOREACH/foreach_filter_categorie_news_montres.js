...
function filterSearchBarMenuNewsMontres(){
...
link_btn_light.setAttribute('href', products.img_article);
...
link_btn_light.appendChild(txt_span_text);
    ...
    $.get("http://localhost:8080/bdd_news_montres", function (response, error) {
