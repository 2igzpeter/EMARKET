...
function afficherProducts(tableauDeProduits) {
    tableauDeProduits.forEach(function (products) {
        ...
        link_btn.setAttribute('class', 'btn btn-light btn-block');
        ...
        link_btn_light.setAttribute('class', 'btn btn-outline-primary btn-block');
    ...
    $.get("http://localhost:8080/filterSearchBar", function (response, error) {
