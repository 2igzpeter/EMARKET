    ...
    container.appendChild(figure_balise);
    ...
    card_img.setAttribute('src', 'images/items/4.jpg');
    ...
    var text_link_title = document.createTextNode('Produt name goes here just for demo item');
    ...
    var txt_del_price_old = document.createTextNode('$198');
    ...
    var txt_text_success = document.createTextNode('Free shipping');
    ...
    link_btn_light.appendChild(txt_span_text);
        ...
        $.get("http://localhost:8080/bdd_products", function (response, error) {
